...
export class MainPanel extends Component {
    ...
    componentWillUnmount() {
        ...
        this.removeListeners(this.state.listenrLists)
    }

    removeListeners = (listners) => {
    ...
    addTypingListeners = (chatRoomId) => {
        ...
        //listenrLists state에 등록된 리스너를 넣어주기
        this.addTolistenrLists(chatRoomId, this.state.typingRef, "child_added")
        ...
        //listenrLists state에 등록된 리스너를 넣어주기
        this.addTolistenrLists(chatRoomId, this.state.typingRef, "child_removed")
    }

    addTolistenrLists = (id, ref, event) => {
        const index = this.state.listenrLists.findIndex(listner => {
            return (
                listner.id === id &&
                listner.ref === ref &&
                listner.event === event
        ...
        if (index === -1) {
            ...
            this.setState( {
                listenrLists: this. state.listenrLists.concat(newListner)
            })
        }
    }
